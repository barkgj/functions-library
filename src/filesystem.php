...
function brk_fs_createsymboliclink($args)
{
	extract($args);
...
function brk_fs_md5hashfolder($args)
{
	$folder = $args["folder"];
	if ($folder == "")
	{
...
function brk_fs_createtempdir($dir=false,$prefix='php') 
{
	$result = array();
...
function brk_fs_removedirectoryrecursively($path)
{
...
function brk_fs_is_dir_empty($dir) 
{
...
function brk_fs_createcontainingfolderforfilepathifnotexists($filepath, $mode = 0777)
{
...
function brk_fs_human_filesize($bytes, $decimals = 2) 
{
...
function brk_fs_get_mime_type($filename)
{
